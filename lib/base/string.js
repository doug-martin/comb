...
comb.string = {
     ...
     * @param {Number} times the number of times to multiply it by
     *
     * @return {String} a string that is the original string multiplied. If times is zero or omitted then the
