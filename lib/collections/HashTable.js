...
module.exports = exports = HashTable = define([Collection, Iterable], {
    ...
    instance:{
        ...
        /**
         * <p>
         * <p>Implementation of a HashTable for javascript. This HashTable implementation allows one to use anything
         * as a key.</p>
         * <b>NOTE: THIS IS ~ 3 times slower than javascript native objects</b>
         *
         * <p>A use case for this collection is when one needs to store items in which the key will not be a string,
         * or number</p>
         * </p>
         *
         * @constructs
